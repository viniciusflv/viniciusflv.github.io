...
Esse comando será referenciado pelo **`turbo run bundle`** definido na raiz e no turbo.json, assim sempre que exista um comando igual nas bibliotecas, ele **também será executado** em paralelo.
