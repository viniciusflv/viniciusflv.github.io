...
Agora você pode **importar** no seu componente o JSON do SVG e o adaptador para **renderizar** o SVG, passando o svg na prop **src** e um texto alternativo na prop **alt** para acessibilidade:
